...
My recommendations:
1. We classified users into 4 categories and saw that the average of users walk more than 7,500 steps daily except on Sundays. We can encourage customers to reach at least the daily recommended steps by CDC - 8.000 steps. By sending them alarms if they haven't reached the steps goal and sending a notification on our app explaining the benefits of reaching that goal.
